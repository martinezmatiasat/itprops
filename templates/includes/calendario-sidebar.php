<aside class="notification-sidebar d-none d-sm-none d-md-block" id="calendario-sidebar"><a class="notification-sidebar-close" id="calendario-sidebar-close"><i class="ft-x font-medium-3 grey darken-1"></i></a>
   <div class="side-nav notification-sidebar-content" id="calendario-sidebar-content">
      <div class="row">
         ...
         <div class="col-12 notification-tab-content" id="calendario-tab-content">
                           ...
                           <li class="timeline-item">
                              ...
                              <div class="activity-list-text">
                                 ...
                                 <div class="notification-note">
                                    <div class="p-1 pl-2"><a href=<?php echo URL . "calendario"; ?>><span class="text-bold-500">Ver calendario completo</span></a></div>
                                 </div>
                              </div>
                           </li>
                           <li class="timeline-item">
