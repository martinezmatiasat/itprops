<aside class="notification-sidebar d-none d-sm-none d-md-block" id="consultas-sidebar"><a class="notification-sidebar-close" id="consultas-sidebar-close"><i class="ft-x font-medium-3 grey darken-1"></i></a>
   <div class="side-nav notification-sidebar-content" id="consultas-sidebar-content">
      <div class="row">
         ...
         <div class="col-12 notification-tab-content" id="consultas-tab-content">
            <div class="tab-content">
               <div class="row tab-pane active" id="activity-tab" role="tabpanel" aria-expanded="true" aria-labelledby="base-tab1">
                  <div class="col-12" id="activity">
                     <h5 class="my-2 text-bold-500">Consultas</h5>
