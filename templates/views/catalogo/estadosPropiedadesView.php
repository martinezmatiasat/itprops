                        ...
                        <div class="card-body">
                           ...
                           <div class="table-responsive">
                              <table id="users-list-datatable" class="table">
                                 <thead>
                                    <tr>
                                       <th>Nombre (Estado de Propiedad)</th>
                                       <th>Edit</th>
                                    </tr>
                                 </thead>
                                 <tbody>
                                    <tr>
                                       <td>Santa Fe</td>
                                       <td>
                                          <a href=<?php echo URL . "catalogo/eliminar_estado_prop"; ?>>
                           ...
                           <!-- Datatable ends -->
                           <a href=<?= URL . "catalogo/nuevo-tipo-prop"; ?> type="button" class="btn btn-primary mt-4 mr-2"><i class="ft-plus mr-1"></i>Nuevo Estado</a>
                        </div>
                     </div>
                  </div>
               </div>
